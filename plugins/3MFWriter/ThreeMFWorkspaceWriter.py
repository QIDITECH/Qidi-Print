...
from QD.Workspace.WorkspaceWriter import WorkspaceWriter
...
class ThreeMFWorkspaceWriter(WorkspaceWriter):
    ...
    def write(self, stream, nodes, mode=WorkspaceWriter.OutputMode.BinaryMode):
        ...
        try:
            ...
            for extruder_stack in global_stack.extruderList:
                ...
                for container in extruder_stack.getContainers():
                    #Logger.log("e",container.getMetaDataEntry("definition"))
                    #if container.getMetaDataEntry("definition") == "i-fast":
                    #    container.setMetaDataEntry("definition","")
                    #    Logger.log("e",container.getMetaDataEntry("definition"))
        ...
        for preference in {"general/visible_settings", "qidi/active_mode", "qidi/categories_expanded", "metadata/setting_version"}:
        ...
        try:
            ...
            version_config_parser.set("versions", "qidi_version", application.getVersion())
    ...
    def _writeContainerToArchive(container, archive):
        ...
        try:
            if file_name in archive.namelist():
                return  # File was already saved, no need to do it again. QDTECH guarantees unique ID's, so this should hold.
