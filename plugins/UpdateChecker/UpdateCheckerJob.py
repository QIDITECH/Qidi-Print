...
class UpdateCheckerJob(Job):
    ...
    def run(self):
        ...
        application_name = "qidi"#Application.getInstance().getApplicationName()
        ...
        try:
            ...
            # QIDI-6698 Create an SSL context and use certifi CA certificates for verification.
    ...
    def showUpdate(self, newest_version: Version, download_url: str) -> None:
        ...
        message.addAction("next_time", i18n_catalog.i18nc("@action:button", "Next time"), "[no_icon]", "[no_description]",
