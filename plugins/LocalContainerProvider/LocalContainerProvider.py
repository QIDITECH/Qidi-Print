...
from QD.Application import Application  # To get the current version for finding the cache directory.
from QD.ConfigurationErrorMessage import ConfigurationErrorMessage
from QD.Logger import Logger
from QD.MimeTypeDatabase import MimeTypeDatabase, MimeType  # To get the type of container we're loading.
from QD.Platform import Platform
from QD.Resources import Resources
from QD.SaveFile import SaveFile
from QD.Settings.ContainerProvider import ContainerProvider  # The class we're implementing.
from QD.Settings.ContainerRegistry import ContainerRegistry  # To get the resource types for containers.
from QD.Settings.DefinitionContainer import DefinitionContainer  # To check if we need to cache this container.
...
class LocalContainerProvider(ContainerProvider):
    ...
    def _saveCachedDefinition(self, definition: DefinitionContainer) -> None:
        ...
        try:
            ...
            Logger.log("w", "QIDI didn't get permission to save the definition {definition_id}".format(definition_id = definition.getId()))
