# Copyright (c) 2019 fieldOfView, QIDI B.V.
# QIDI is released under the terms of the LGPLv3 or higher.

# This AMF parser is based on the AMF parser in legacy qidi:
# https://github.com/daid/LegacyQIDI/blob/ad7641e059048c7dcb25da1f47c0a7e95e7f4f7c/QIDI/util/meshLoaders/amf.py
...
from QD.Mesh.MeshData import MeshData, calculateNormalsFromIndexedVertices
...
class AMFReader(MeshReader):
    ...
    def _read(self, file_name):
        ...
        for amf_object in amf_document.iter("object"):
            for amf_mesh in amf_object.iter("mesh"):
                ...
                for volume in amf_mesh.iter("volume"):
                    ...
                    new_node.addDecorator(BuildPlateDecorator(QIDIApplication.getInstance().getMultiBuildPlateModel().activeBuildPlate))
        ...
        group_node.addDecorator(BuildPlateDecorator(QIDIApplication.getInstance().getMultiBuildPlateModel().activeBuildPlate))
