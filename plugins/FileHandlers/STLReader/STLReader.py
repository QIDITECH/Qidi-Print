...
try:
    # Work around for QIDI-7154. Some models crash with a segfault, but only when packed.
...
class STLReader(MeshReader):
    ...
    def load_file(self, file_name, mesh_builder, _use_numpystl = False):
        ...
        # Logger.log("e",mesh_builder.getVertices())
        # Logger.log("e",mesh_builder.getNormals())
    ...
    def _read(self, file_name):
        ...
        # Logger.log("e",mesh.getCenterPosition())
        if use_numpystl:
