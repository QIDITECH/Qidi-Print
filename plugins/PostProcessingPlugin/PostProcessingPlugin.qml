...
UM.Dialog
{
    ...
    Item
    {
        ...
        id: base
        property int columnWidth: Math.round((base.width * 0.4) - UM.Theme.getSize("default_margin").width)
    ...
    Button {
        ...
        style: ButtonStyle {
            background: Rectangle {
                ...
                border.color: !control.enabled ? UM.Theme.getColor("color4") :
                                  control.pressed ? UM.Theme.getColor("color12") :
                                  control.hovered ? UM.Theme.getColor("color12") : UM.Theme.getColor("color4")
                color: !control.enabled ? UM.Theme.getColor("color1") :
                           control.pressed ? UM.Theme.getColor("color1") :
                           control.hovered ? UM.Theme.getColor("color1") : UM.Theme.getColor("color1")
                ...
                UM.RecolorImage {
                    ...
                    color: !control.enabled ? UM.Theme.getColor("color4") :
                               control.pressed ? UM.Theme.getColor("color12") :
                               control.hovered ? UM.Theme.getColor("color12") : UM.Theme.getColor("color4");
