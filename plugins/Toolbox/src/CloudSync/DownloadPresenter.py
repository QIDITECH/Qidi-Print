...
class DownloadPresenter:
    ...
    def __init__(self, app: QIDIApplication) -> None:
        ...
        self._app = app
        self._scope = QIDICloudScope(app)
    ...
    def _createProgressMessage(self) -> Message:
        return Message(i18n_catalog.i18nc("@info:generic", "Syncing..."),
            ...
            progress = 0.0,
            title = i18n_catalog.i18nc("@info:title", "Changes detected from your QIDI account", ))

    def _onFinished(self, package_id: str, reply: QNetworkReply) -> None:
        self._progress[package_id]["received"] = self._progress[package_id]["total"]

        try:
            with tempfile.NamedTemporaryFile(mode = "wb+", suffix = ".qidipackage", delete = False) as temp_file:
