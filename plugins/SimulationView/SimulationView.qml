...
Item
{
    ...
    width: {
        ...
        {
            b = 27 * UM.Theme.getSize("default_margin").width/10 + UM.Theme.getSize("default_margin").width
        }
        else
        {
            b = 0
        ...
        if (UM.SimulationView.compatibilityMode) {
            return UM.Theme.getSize("layerview_menu_size_compatibility").width + UM.Theme.getSize("slider_handle").width + b;
        } else {
            return UM.Theme.getSize("layerview_menu_size").width + UM.Theme.getSize("slider_handle").width + b + 10 * UM.Theme.getSize("default_margin").width/10;
        }
    }
    height: {
        var a = 0
        if(pathSlider.visible)
        {
            a = 10 * UM.Theme.getSize("default_margin").width/10
        }
        else
        {
            a = -10 * UM.Theme.getSize("default_margin").width/10
        ...
        if (viewSettings.collapsed) {
            if (UM.SimulationView.compatibilityMode) {
                return UM.Theme.getSize("layerview_menu_size_compatibility_collapsed").height + a;
            }
            return UM.Theme.getSize("layerview_menu_size_collapsed").height + a;
        } else if (UM.SimulationView.compatibilityMode) {
            return UM.Theme.getSize("layerview_menu_size_compatibility").height + a;
        } else if (UM.Preferences.getValue("layerview/layer_view_type") == 0) {
            return UM.Theme.getSize("layerview_menu_size_material_color_mode").height + UM.SimulationView.extruderCount * (UM.Theme.getSize("layerview_row").height + UM.Theme.getSize("layerview_row_spacing").height) + a + 5 * UM.Theme.getSize("default_margin").width/10
        } else {
            return UM.Theme.getSize("layerview_menu_size").height + UM.SimulationView.extruderCount * (UM.Theme.getSize("layerview_row").height + UM.Theme.getSize("layerview_row_spacing").height) + a + 5 * UM.Theme.getSize("default_margin").width/10
        }
    }
...
/*
        ...
        ColumnLayout {
            ...
            anchors.right: parent.right
            anchors.rightMargin: layerSlider.visible ? UM.Theme.getSize("default_margin").width * 2 + 50 * UM.Theme.getSize("default_margin").width/10 : UM.Theme.getSize("default_margin").width
...
/*
            ...
            Repeater {
                ...
                CheckBox {
                    ...
                    Rectangle {
                        ...
                        color: index == 0 ? Qt.lighter(model.color, 1.1) : Qt.lighter(model.color, 0.75)
    ...
    Item {
        ...
        PathSlider {
            ...
            width: 110 * UM.Theme.getSize("default_margin").width/10
        ...
        LayerSlider {
            ...
            height: UM.Theme.getSize("layerview_menu_size").height - 26 * UM.Theme.getSize("default_margin").width/10

            anchors {
                //top: parent.top//!UM.SimulationView.compatibilityMode ? pathSlider.bottom : parent.top
                //topMargin: !UM.SimulationView.compatibilityMode ? UM.Theme.getSize("default_margin").height + 1 : 0
                left: pathSlider.right
                //right: parent.right
                leftMargin: 23 * UM.Theme.getSize("default_margin").width/10
                bottom: parent.bottom
