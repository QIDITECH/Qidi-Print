    ...
    def render(self):
        if not self._layer_shader:
            if self._compatibility_mode:
                ...
                # shader_filename = "color.shader"
                # shadow_shader_filename = "color.shader"         
