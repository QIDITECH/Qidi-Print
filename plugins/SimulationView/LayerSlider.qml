...
Item
{
    ...
    // Handle properties
    property real handleSize: QD.Theme.getSize("slider_handle").width
    property real handleRadius: handleSize / 2
    property real minimumRangeHandleSize: handleSize / 2
    property color upperHandleColor: QD.Theme.getColor("slider_handle")
    property color lowerHandleColor: QD.Theme.getColor("slider_handle")
    property color rangeHandleColor: QD.Theme.getColor("slider_groove_fill")
    property color handleActiveColor: QD.Theme.getColor("slider_handle_active")
    property var activeHandle: upperHandle

    // Track properties
    property real trackThickness: QD.Theme.getSize("slider_groove").width // width of the slider track
    property real trackRadius: QD.Theme.getSize("slider_groove_radius").width
    property color trackColor: QD.Theme.getColor("slider_groove")
    ...
    Item
    {
        ...
        function onHandleDragged()
        {
            ...
            QD.SimulationView.setCurrentLayer(upperValue)
            QD.SimulationView.setMinimumLayer(lowerValue)
        }
        ...
        function setValue(value)
        {
            ...
            QD.SimulationView.setCurrentLayer(value)
            QD.SimulationView.setMinimumLayer(value - range)
        }
    ...
    Rectangle
    {
        ...
        function onHandleDragged()
        {
            ...
            QD.SimulationView.setCurrentLayer(getValue())
        }
        ...
        SimulationSliderLabel
        {
            ...
            anchors.bottomMargin: QD.Theme.getSize("narrow_margin").height
    ...
    Rectangle
    {
        ...
        function onHandleDragged()
        {
            ...
            // set the new value after moving the handle position
            QD.SimulationView.setMinimumLayer(getValue())
        }
        ...
        function setValue(value)
        {
            ...
            QD.SimulationView.setMinimumLayer(value)
        ...
        SimulationSliderLabel
        {
            ...
            anchors.topMargin: QD.Theme.getSize("narrow_margin").height
            anchors.horizontalCenter: parent.horizontalCenter
