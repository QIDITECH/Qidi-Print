...
Item
{
    ...
    property color handleColor: QD.Theme.getColor("slider_handle")
    property color handleActiveColor: QD.Theme.getColor("slider_handle_active")
    property color rangeColor: QD.Theme.getColor("slider_groove_fill")
    property real handleLabelWidth: width

    // track properties
    property real trackThickness: QD.Theme.getSize("slider_groove").width
    ...
    Rectangle
    {
        ...
        function onHandleDragged()
        {
            ...
            QD.SimulationView.setCurrentPath(getValue())
        }
        ...
        function setValue(value)
        {
            ...
            QD.SimulationView.setCurrentPath(value)
        ...
        SimulationSliderLabel
        {
            ...
            height: sliderRoot.handleSize + QD.Theme.getSize("default_margin").height
            y: parent.y + sliderRoot.handleSize + QD.Theme.getSize("default_margin").height
