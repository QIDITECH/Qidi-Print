...
class SimulationView(View):
    ...
    def __init__(self):
        ...
        Preferences.getInstance().addPreference("layerview/layer_view_type", 1)
    ...
    def _resetSettings(self):
        self._layer_view_type = 1  # 0 is material color, 1 is color by linetype, 2 is speed, 3 is layer thickness
