...
class ThreeMFReader(MeshReader):
    ...
    def _convertSavitarNodeToUMNode(self, savitar_node: Savitar.SceneNode, file_name: str = "") -> Optional[SceneNode]:
        ...
        um_node = QIDISceneNode() # This adds a SettingOverrideDecorator
        ...
        if len(um_node.getChildren()) > 0 and um_node.getMeshData() is None:
            if len(um_node.getAllChildren()) == 1:
                ...
                um_node = cast(QIDISceneNode, um_node.getChildren()[0])
            else:
    ...
    def _read(self, file_name: str) -> Union[SceneNode, List[SceneNode]]:
        ...
        try:
            ...
            for key, value in scene_3mf.getMetadata().items():
                QIDIApplication.getInstance().getController().getScene().setMetaDataEntry(key, value)
            ...
            for node in scene_3mf.getSceneNodes():
                ...
                # Third step: 3MF also defines a unit, whereas QIDI always assumes mm.
                scale_matrix = Matrix()
