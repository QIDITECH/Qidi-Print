...
from qidi import LayerDataBuilder
from qidi import LayerDataDecorator
from qidi import LayerPolygon
...
class ProcessSlicedLayersJob(Job):
    ...
    def run(self):
        ...
        new_node = QIDISceneNode(no_setting_override = True)
            ...
            for extruder in extruders:
                ...
                if Application.getInstance().getPreferences().getValue("view/use_extruder_color"):
                    if Application.getInstance().getPreferences().getValue("color/extruder" + str(position)):
                        color_code = str(Application.getInstance().getPreferences().getValue("color/extruder" + str(position)))
                    else:
                        color_code
                else:
                    if position == 0 :
                        tempmaterialcolor = color_code
                    elif tempmaterialcolor == color_code:
                        temcolor = int(color_code[5:7],16)
                        ...
                        temcolor2 = int(color_code[3:5],16)
                        ...
                        temcolor3 = int(color_code[1:3],16)
                        ...
                        color_code = color_code[0:1] +temcolor3 + temcolor2 + temcolor
