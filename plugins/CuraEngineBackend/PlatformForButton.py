...
class PlatformForButton(SceneNode.SceneNode):
    ...
    def render(self, renderer):
        ...
        if not self._shader:
            ...
            self._shader.setUniformValue("u_color", Color(0.0,0.0,0.0,0.0))            
            
            # self._shader = OpenGL.getInstance().createShaderProgram(Resources.getPath(Resources.Shaders, "toolhandle.shader"))
            # self._shader.setUniformValue("u_activeColor", Color(0.0,0.0,1.0,1.0))
    ...
    def _onGlobalContainerStackChanged(self):
        ...
        if self._global_container_stack:
            ...
            if container:
                ...
                # offset = container.getMetaDataEntry("arrange_button_offset")
                # if offset:
                    # if len(offset) == 3:
                        # self.setPosition(self._origin)
    ...
    def _onPlatformLoaded(self, job):
        ...
        if node.getMeshData():
            ...
            path = Resources.getPath(Resources.Meshes, "button.STL")
