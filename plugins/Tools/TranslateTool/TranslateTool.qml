...
Item
{
    ...
    Grid
    {
        ...
        TextField
        {
            ...
            height: 23 * UM.Theme.getSize("default_margin").width/10//UM.Theme.getSize("setting_control").height;
    ...
    Button
    {
        ...
        style: UM.Theme.styles.translate_button

        onClicked:
        {
            UM.ActiveTool.setProperty("X", 0)
            UM.ActiveTool.setProperty("Y", 0)
            UM.ActiveTool.setProperty("Z", 0)
        }
    }
    ...
    CheckBox
    {
        ...
        anchors.leftMargin: 5 * UM.Theme.getSize("default_margin").width/10//UM.Theme.getSize("default_margin").width
