...
Item
{
    ...
    property int labelWidth: (columnWidth * 2 / 3 - QD.Theme.getSize("default_margin").width * 2) | 0
    property int controlWidth: (columnWidth / 3) | 0
    property var labelFont: QD.Theme.getFont("default")

    property string machineStackId: QIDI.MachineManager.activeMachine.id
    ...
    RowLayout
    {
        ...
        Column
        {
            ...
            QIDI.NumericTextFieldWithUnit  // "X (Width)"
            {
            ...
            QIDI.NumericTextFieldWithUnit  // "Y (Depth)"
            {
            ...
            QIDI.NumericTextFieldWithUnit  // "Z (Height)"
            {
            ...
            QIDI.ComboBoxWithOptions  // "Build plate shape"
            {
            ...
            QIDI.SimpleCheckBox  // "Origin at center"
            {
            ...
            QIDI.SimpleCheckBox  // "Heated bed"
            {
            ...
            QIDI.SimpleCheckBox  // "Heated build volume"
            {
            ...
            QIDI.ComboBoxWithOptions  // "G-code flavor"
            {
                ...
                // This has something to do with QD2 and QD2+ regarding "has_material" and the gcode flavor settings.
        ...
        Column
        {
            ...
            QIDI.PrintHeadMinMaxTextField  // "X min"
            {
                id: machineXMinField
            ...
            QIDI.PrintHeadMinMaxTextField  // "Y min"
            {
                id: machineYMinField
            ...
            QIDI.PrintHeadMinMaxTextField  // "X max"
            {
                id: machineXMaxField
            ...
            QIDI.PrintHeadMinMaxTextField  // "Y max"
            {
                id: machineYMaxField
            ...
            QIDI.NumericTextFieldWithUnit  // "Gantry Height"
            {
            ...
            QIDI.ComboBoxWithOptions  // "Number of Extruders"
            {
                ...
                optionModel: ListModel
                {
                    ...
                    {
                        clear()
                        for (var i = 1; i <= QIDI.MachineManager.activeMachine.maxExtruderCount; i++)
                        {
            ...
            QIDI.SimpleCheckBox  // "GCode Affected By Extruder Offsets"
            {
            ...
            See: https://github.com/QIDI/QIDI/issues/8148

            QIDI.SimpleCheckBox  // "Shared Heater"
            {
    ...
    RowLayout  // Start and End G-code
    {
        ...
        QIDI.GcodeTextArea   // "Start G-code"
        {
            Layout.fillWidth: true
