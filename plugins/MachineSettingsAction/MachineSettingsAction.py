...
from qidi.MachineAction import MachineAction
from qidi.Machines.ContainerTree import ContainerTree  # To re-build the machine node when hasMaterials changes.
from qidi.Settings.QIDIStackBuilder import QIDIStackBuilder
from qidi.Settings.qidi_empty_instance_containers import isEmptyContainer

if TYPE_CHECKING:
    from PyQt5.QtCore import QObject

catalog = QD.i18n.i18nCatalog("qidi")
...
class MachineSettingsAction(MachineAction):
    ...
    def _reset(self):
        ...
        if isEmptyContainer(definition_changes_id):
            QIDIStackBuilder.createDefinitionChangesContainer(global_stack,
