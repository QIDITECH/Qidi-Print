...
class LocalFileOutputDevice(ProjectOutputDevice):
    ...
    def requestWrite(self, nodes, file_name = None, limit_mimetypes = None, file_handler = None, **kwargs):
        ...
        # QIDI-6411: This code needs to be before dialog.selectFile and the filters, because otherwise in macOS (for some reason) the setDirectory call doesn't work.
    ...
    def _onWriteJobFinished(self, job):
        ...
        if job.getResult():
            ...
            if QIDIApplication.getInstance()._want_to_close:
                QIDIApplication.getInstance().checkAndExitApplication()
            else:
