...
class QIDISceneController(QObject):
    ...
    def _sceneHasSupportMeshes(self):
        ...
        for node in root.getAllChildren():
            if isinstance(node, QIDISceneNode):
    ...
    def createQIDISceneController():
        ...
        return QIDISceneController(objects_model = objects_model, multi_build_plate_model = multi_build_plate_model)
