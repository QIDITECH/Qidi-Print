...
from qidi.QIDIApplication import QIDIApplication #To find some resource types.
from qidi.Settings.GlobalStack import GlobalStack

from QD.PackageManager import PackageManager #The class we're extending.
from QD.Resources import Resources #To find storage paths for some resource types.
...
class QIDIPackageManager(PackageManager):
    def __init__(self, application: "QtApplication", parent: Optional["QObject"] = None) -> None:
        super().__init__(application, parent)

    def initialize(self) -> None:
        self._installation_dirs_dict["materials"] = Resources.getStoragePath(QIDIApplication.ResourceTypes.MaterialInstanceContainer)
        self._installation_dirs_dict["qualities"] = Resources.getStoragePath(QIDIApplication.ResourceTypes.QualityInstanceContainer)
