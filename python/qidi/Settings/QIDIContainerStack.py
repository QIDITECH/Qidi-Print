...
from QD.Settings.ContainerStack import ContainerStack, InvalidContainerStackError
...
from QD.Settings.Interfaces import ContainerInterface, DefinitionContainerInterface
from qidi.Settings import qidi_empty_instance_containers

from . import Exceptions


class QIDIContainerStack(ContainerStack):
    """Base class for QIDI related stacks that want to enforce certain containers are available.
    ...
    def __init__(self, container_id: str) -> None:
        ...
        self._empty_instance_container = qidi_empty_instance_containers.empty_container #type: InstanceContainer

        self._empty_quality_changes = qidi_empty_instance_containers.empty_quality_changes_container #type: InstanceContainer
        self._empty_quality = qidi_empty_instance_containers.empty_quality_container #type: InstanceContainer
        self._empty_material = qidi_empty_instance_containers.empty_material_container #type: InstanceContainer
        self._empty_variant = qidi_empty_instance_containers.empty_variant_container #type: InstanceContainer
        ...
        import qidi.QIDIApplication #Here to prevent circular imports.
        self.setMetaDataEntry("setting_version", qidi.QIDIApplication.QIDIApplication.SettingVersion)
    ...
    def deserialize(self, serialized: str, file_name: Optional[str] = None) -> str:
        ...
        if isinstance(new_containers[_ContainerIndexes.DefinitionChanges], type(self._empty_instance_container)):
            ...
            QIDIStackBuilder.createDefinitionChangesContainer(self, self.getId() + "_settings")
