...
from QD.Settings.Interfaces import ContainerInterface, PropertyEvaluationContext
from QD.Util import parseBool

import qidi.QIDIApplication

from . import Exceptions
from .QIDIContainerStack import QIDIContainerStack, _ContainerIndexes
...
class ExtruderStack(QIDIContainerStack):
...
extruder_stack_mime = MimeType(
    name = "application/x-qidi-extruderstack",
    comment = "QIDI Extruder Stack",
