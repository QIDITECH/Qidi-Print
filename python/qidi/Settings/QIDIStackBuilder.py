...
class QIDIStackBuilder:
    ...
    def createMachine(cls, name: str, definition_id: str, machine_extruder_count: Optional[int] = None) -> Optional[GlobalStack]:
        ...
        # extruder stack because the global stack didn't have one yet (which is enforced since QIDI 3.1).
    ...
    def createUserChangesContainer(cls, container_name: str, definition_id: str, stack_id: str,
        ...
        container.setMetaDataEntry("setting_version", QIDIApplication.SettingVersion)
    ...
    def createDefinitionChangesContainer(cls, container_stack, container_name):
        ...
        definition_changes_container.setMetaDataEntry("setting_version", QIDIApplication.SettingVersion)
