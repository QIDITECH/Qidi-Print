...
if TYPE_CHECKING:
    ...
    from qidi.Settings.QIDIContainerStack import QIDIContainerStack


#
# This class contains all QIDI-related custom functions that can be used in formulas. Some functions requires
# information such as the currently active machine, so this is made into a class instead of standalone functions.
#
class QIDIFormulaFunctions:
    ...
    def createContextForDefaultValueEvaluation(self, source_stack: "QIDIContainerStack") -> "PropertyEvaluationContext":
