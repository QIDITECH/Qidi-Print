...
# the current stacks and container, which have not completely been updated yet, so QIDI will crash in this case.
#
...
def call_on_qt_thread(func):
    ...
    def _call_on_qt_thread_wrapper(*args, **kwargs):
        ...
        qidi.QIDIApplication.QIDIApplication.getInstance().callLater(_handle_call, *new_args, **kwargs)
