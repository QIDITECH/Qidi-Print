...
from qidi.PrinterOutput.Peripheral import Peripheral
from qidi.PrinterOutput.Models.PrinterConfigurationModel import PrinterConfigurationModel
from qidi.PrinterOutput.Models.ExtruderOutputModel import ExtruderOutputModel
from QD.Logger import Logger

if TYPE_CHECKING:
    from qidi.PrinterOutput.Models.PrintJobOutputModel import PrintJobOutputModel
    from qidi.PrinterOutput.PrinterOutputController import PrinterOutputController
...
class PrinterOutputModel(QObject):
    ...
    # Stub to connect QD.Signal to pyqtSignal
