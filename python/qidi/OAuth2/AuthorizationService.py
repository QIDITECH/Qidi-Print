...
from qidi.OAuth2.AuthorizationHelpers import AuthorizationHelpers, TOKEN_TIMESTAMP_FORMAT
from qidi.OAuth2.LocalAuthorizationServer import LocalAuthorizationServer
from qidi.OAuth2.Models import AuthenticationResponse

i18n_catalog = i18nCatalog("qidi")

if TYPE_CHECKING:
    from qidi.OAuth2.Models import UserProfile, OAuth2Settings
    from QD.Preferences import Preferences

MYCLOUD_LOGOFF_URL = "https://mycloud.qidi.com/logoff"
...
class AuthorizationService:
    ...
    def getUserProfile(self) -> Optional["UserProfile"]:
        ...
        See also: :py:method:`qidi.OAuth2.AuthorizationService.AuthorizationService._parseJWT`
        """
    ...
    def getAccessToken(self) -> Optional[str]:
        ...
        # We have a fallback on a date far in the past for currently stored auth data in qidi.cfg.
    ...
    def startAuthorizationFlow(self, force_browser_logout: bool = False) -> None:
        ...
        # This is needed because the QIDIDrivePlugin is a untrusted (open source) client.
        ...
        try:
            ...
            if preferences_data:
                ...
                if user_profile is not None:
                    ...
                    self._unable_to_get_data_message = Message(i18n_catalog.i18nc("@info", "Unable to reach the QIDI account server."), title = i18n_catalog.i18nc("@info:title", "Warning"))
