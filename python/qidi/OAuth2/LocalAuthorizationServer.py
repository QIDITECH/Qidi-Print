...
try:
    from qidi.OAuth2.AuthorizationRequestServer import AuthorizationRequestServer
    from qidi.OAuth2.AuthorizationRequestHandler import AuthorizationRequestHandler
    got_server_type = True
except PermissionError:  # Bug in http.server: Can't access MIME types. This will prevent the user from logging in. See Sentry bug QIDI-3Q.
...
if TYPE_CHECKING:
    ...
    from qidi.OAuth2.AuthorizationHelpers import AuthorizationHelpers
...
class LocalAuthorizationServer:
    def __init__(self, auth_helpers: "AuthorizationHelpers",
        ...
        :py:meth:`qidi.OAuth2.LocalAuthorizationServer.LocalAuthorizationServer.stop()`
