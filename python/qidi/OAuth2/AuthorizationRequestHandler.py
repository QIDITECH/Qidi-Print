...
from qidi.OAuth2.Models import AuthenticationResponse, ResponseData, HTTP_STATUS
from QD.i18n import i18nCatalog

if TYPE_CHECKING:
    from qidi.OAuth2.Models import ResponseStatus
...
class AuthorizationRequestHandler(BaseHTTPRequestHandler):
    ...
    # QIDI-6609: Some browser seems to issue a HEAD instead of GET request as the callback.
