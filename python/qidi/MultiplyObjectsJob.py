...
from qidi.Arranging.Nest2DArrange import arrange_copy

i18n_catalog = i18nCatalog("qidi")


class MultiplyObjectsJob(Job):
    def __init__(self, objects, count, spacing,checked, min_offset = 8):
        super().__init__()
    ...
    def run(self) -> None:
        ...
        if nodes:
            found_solution_for_all = arrange_copy(nodes, Application.getInstance().getBuildVolume(), fixed_nodes,self._spacing,self._checked,
