...
from QD.Settings.ContainerRegistry import ContainerRegistry  # To find all the variants for this machine.
...
from qidi.Machines.QualityChangesGroup import QualityChangesGroup  # To construct groups of quality changes profiles that belong together.
from qidi.Machines.QualityGroup import QualityGroup  # To construct groups of quality profiles that belong together.
        ...
        for quality_changes in machine_quality_changes:
            ...
            if name not in groups_by_name:
                ...
                groups_by_name[name] = QualityChangesGroup(name, quality_type = quality_changes["quality_type"],
                                                           ...
                                                           parent = QIDIApplication.getInstance())
    ...
    def _loadAll(self) -> None:
        ...
        if not self.has_variants:
            ...
            for variant in variants:
                ...
                if variant_name not in self.variants:
                    ...
                    # when the G-Code flavor changes --> QIDI-7354
        ...
        if not global_qualities:  # This printer doesn't override the global qualities.
            ...
            if not global_qualities:  # There are no global qualities either?! Something went very wrong, but we'll not crash and properly fill the tree.
                global_qualities = [qidi.QIDIApplication.QIDIApplication.getInstance().empty_quality_container.getMetaData()]
