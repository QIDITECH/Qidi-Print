...
class UserChangesModel(ListModel):
    ...
    def _update(self):
        ...
        qidi_formula_functions = application.getQIDIFormulaFunctions()
        ...
        for stack in stacks:
            ...
            default_value_resolve_context = qidi_formula_functions.createContextForDefaultValueEvaluation(stack)
