...
from QD.Settings.ContainerRegistry import ContainerRegistry #To update the list if anything changes.
from PyQt5.QtCore import pyqtSignal
import qidi.QIDIApplication
if TYPE_CHECKING:
    from QD.Settings.ContainerRegistry import ContainerInterface
    ...
    def _get_translations(cls):
        ...
        if len(cls._translations) == 0:
            ...
            cls._translations["engineering"] = {
                ...
                "description": catalog.i18nc("@text", "The engineering profile is designed to print functional prototypes and end-use parts with the intent of better acqidicy and for closer tolerances.")
            }
