...
class MaterialUsersModel(BaseMaterialsModel):
    ...
    def _update(self):
        ...
        for root_material_id, container_node in self._available_materials.items():
            ...
            if container_node.getMetaDataEntry("brand", "unknown").lower() == "generic" or container_node.getMetaDataEntry("brand", "unknown").lower() == "qidi":
                continue
