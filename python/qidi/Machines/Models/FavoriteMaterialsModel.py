...
import qidi.QIDIApplication  # To listen to changes to the preferences.
...
class FavoriteMaterialsModel(BaseMaterialsModel):
    ...
    def __init__(self, parent = None):
        ...
        qidi.QIDIApplication.QIDIApplication.getInstance().getPreferences().preferenceChanged.connect(self._onFavoritesChanged)
        self._onChanged()
    ...
    def _onFavoritesChanged(self, preference_key: str) -> None:
        ...
        if preference_key != "qidi/favorite_materials":
            return
        self._onChanged()
