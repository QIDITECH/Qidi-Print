...
import qidi.QIDIApplication  # Imported this way to prevent circular dependencies.
...
class QualityProfilesDropDownMenuModel(ListModel):
    ...
    def _update(self):
        ...
        # QD.ListModel, the model will not remove all items and recreate new ones every time there's an update.
        ...
        if not qidi.QIDIApplication.QIDIApplication.getInstance().getMachineManager().activeMaterialsCompatible():
