...
class LayerDataBuilder(MeshBuilder):
    """Builder class for constructing a :py:class:`qidi.LayerData.LayerData` object"""
    ...
    def build(self, material_color_map, line_type_brightness = 1.0):
        """Return the layer data as :py:class:`qidi.LayerData.LayerData`.
        ...
        for extruder_nr in range(material_color_map.shape[0]):
            ...
            #Logger.log("e",material_color_map[extruder_nr])
