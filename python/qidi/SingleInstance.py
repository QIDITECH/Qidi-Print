...
from QD.Qt.QtApplication import QtApplication #For typing.
...
class SingleInstance:
    ...
    def startClient(self) -> bool:
        Logger.log("i", "Checking for the presence of an ready running QIDI instance.")
        ...
        single_instance_socket.connectToServer("qidi-qidi")
        ...
        if single_instance_socket.state() == QLocalSocket.ConnectedState:
            Logger.log("i", "Connection has been made to the single-instance QIDI socket.")
    ...
    def startServer(self) -> None:
        ...
        if self._single_instance_server:
            ...
            self._single_instance_server.listen("qidi-qidi")
        else:
