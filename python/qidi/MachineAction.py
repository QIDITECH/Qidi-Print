...
class MachineAction(QObject, PluginObject):
    ...
    machine action can also have a qml, which should contain a :py:class:`qidi.MachineAction.MachineAction` item.
    ...
    def reset(self) -> None:
        ...
        :py:meth:`qidi.MachineAction.MachineAction._reset`
        """
    ...
    def _reset(self) -> None:
        ...
        See also :py:meth:`qidi.MachineAction.MachineAction.reset`
        """
    ...
    def _createViewFromQML(self) -> Optional["QObject"]:
        ...
        view = QIDIApplication.getInstance().createQmlComponent(path, {"manager": self})
        return view
