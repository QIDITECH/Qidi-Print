...
######用于不受喷头数量影响的参数设置
    @pyqtSlot(str, str, str)
    def setSettingForExtruders(self, setting_name: str, property_name: str, property_value: str) -> None:
        self._global_container_stack.userChanges.setProperty(setting_name, property_name, property_value)
######
