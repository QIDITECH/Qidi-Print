...
class MainWindow(QQuickWindow):
    def __init__(self, parent = None):
        ...
        self._background_color = QColor(210, 208, 210, 255)
...
#    @pyqtSlot(result = "QVariantList")              #不能用list,tuple这种类型，但可以用QVariantList,QVariantMap之类
    def screenshotImages(self):
        result = []
        result.append(self._app.getRenderer().getRenderPass("default").getOutput())
        result.append(self._app.getRenderer().getRenderPass("selection").getOutput())
        return result
