...
from QD.PluginError import PluginNotFoundError, InvalidMetaDataError
from QD.PluginObject import PluginObject  # For type hinting
...
class PluginRegistry(QObject):
    ...
    def __init__(self, application: "Application", parent: QObject = None) -> None:
        ...
        self._supported_file_types = {"umplugin": "QDTECH Plugin"} # type: Dict[str, str]
    ...
    # Installed: A plugin which is installed locally in QIDI.
