...
#
# An example of code which uses this profiling data is this QIDI plugin:
# https://github.com/sedwards2009/qidi-big-flame-graph
#
# Set the environment variable URANIQD_FLAME_PROFILER to something before
# starting the application to make the profiling code available.


def enabled() -> bool:
    return "URANIQD_FLAME_PROFILER" in os.environ
