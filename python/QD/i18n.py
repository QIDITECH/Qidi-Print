...
class i18nCatalog: # [CodeStyle: QIDI code style requires classes to start with a upper case. But i18n is lower case by convention.] pylint: disable=invalid-name
