...
from QD.LockFile import LockFile
from QD.Logger import Logger
from QD.MimeTypeDatabase import MimeType, MimeTypeDatabase
from QD.PluginRegistry import PluginRegistry #To register the container type plug-ins and container provider plug-ins.
...
from QD.Settings.ContainerProvider import ContainerProvider
from QD.Settings.constant_instance_containers import empty_container
...
from QD.Settings.Interfaces import ContainerInterface, ContainerRegistryInterface, DefinitionContainerInterface
...
class ContainerRegistry(ContainerRegistryInterface):
    ...
    def getMimeTypeForContainer(cls, container_type: type) -> Optional[MimeType]:
        ...
        try:
            mime_type_name = QD.Dictionary.findKey(cls.mime_type_map, container_type)
            if mime_type_name:
    ...
    def _onContainerMetaDataChanged(self, *args: ContainerInterface, **kwargs: Any) -> None:
        ...
        that doesn't work automatically between pyqtSignal and QD.Signal.
        """
    ...
    mime_type_map = {
        "application/x-qdtech-definitioncontainer": DefinitionContainer,
        "application/x-qdtech-instancecontainer": InstanceContainer,
        "application/x-qdtech-containerstack": ContainerStack,
        "application/x-qdtech-extruderstack": ContainerStack
