...
from QD.i18n import i18nCatalog #For typing.
...
from QD.Settings.PropertyEvaluationContext import PropertyEvaluationContext
from QD.Settings.SettingDefinition import SettingDefinition
from QD.Settings.SettingDefinition import DefinitionPropertyType
from QD.Settings.SettingRelation import SettingRelation
...
MimeTypeDatabase.addMimeType(
    MimeType(
        name = "application/x-qdtech-definitioncontainer",
        comment = "QDTECH Definition Container",
        suffixes = ["def.json"]
    )
)
...
class DefinitionContainer(QObject, DefinitionContainerInterface, PluginObject):
    ...
    def deserializeMetadata(cls, serialized: str, container_id: str) -> List[Dict[str, Any]]:
        ...
        if "inherits" in parsed:
            import QD.Settings.ContainerRegistry #To find the definitions we're inheriting from.
            parent_metadata = QD.Settings.ContainerRegistry.ContainerRegistry.getInstance().findDefinitionContainersMetadata(id = parsed["inherits"])
