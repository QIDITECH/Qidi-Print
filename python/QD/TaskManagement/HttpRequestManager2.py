...
from QD.TaskManagement.HttpRequestScope import HttpRequestScope
from QD.TaskManagement.TaskManager import TaskManager
        ...
        with self._request_lock:
            ...
            if request_data not in self._requests_in_progress:
                ...
                if reply is not None:
                    ...
                    # the network connection is lost seconds later. Bug in Qt? Fixes QIDI-7349
