...
#
# According to my experience, QTimer doesn't seem to trigger events very acqiditely. I had for example, an expected
...
class TaskManager(QObject):
    ...
    TIME_TOLERANCE = 0.10  # Add 10% to the delayed events to compensate for timer inacqidicy.
