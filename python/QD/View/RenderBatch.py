...
class RenderBatch:
    ...
    def render(self, camera: Optional[Camera]):
        ...
        elif self._render_type == self.RenderType.test:
            self._gl.glEnable(self._gl.GL_DEPTH_TEST)
            self._gl.glDepthMask(self._gl.GL_TRUE)
            self._blend_mode = self.BlendMode.Normal
        ...
        elif self._blend_mode == self.BlendMode.Transparent:
            # self._gl.glDepthMask(self._gl.GL_FALSE)
            self._gl.glEnable(self._gl.GL_BLEND)
            # self._gl.glBlendFunc(self._gl.GL_SRC_ALPHA, self._gl.GL_ONE_MINUS_SRC_ALPHA)
            self._gl.glBlendFunc(self._gl.GL_SRC_ALPHA, self._gl.GL_ONE)
            # self._gl.glBlendFunc(self._gl.GL_ONE_MINUS_SRC_COLOR, self._gl.GL_SRC_ALPHA)
            # self._gl.glBlendFunc(self._gl.GL_ONE_MINUS_SRC_ALPHA, self._gl.GL_ONE)
            # GL_SRC_ALPHA，GL_ONE_MINUS_SRC_ALPHA
        # elif self._blend_mode == self.BlendMode.Transparent:
            # self._gl.glEnable(self._gl.GL_BLEND)
            # self._gl.glBlendFunc(self._gl.GL_SRC_ALPHA, self._gl.GL_ONE_MINUS_SRC_COLOR)
