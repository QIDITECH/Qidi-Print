...
from QD.View.GL.FrameBufferObject import FrameBufferObject
from QD.View.GL.ShaderProgram import ShaderProgram
from QD.View.GL.ShaderProgram import InvalidShaderProgramError
from QD.View.GL.Texture import Texture
from QD.View.GL.OpenGLContext import OpenGLContext
from QD.i18n import i18nCatalog  # To make dialogs translatable.
...
class OpenGL:
    ...
    def __init__(self) -> None:
        ...
        # WORKAROUND: QIDI/#1117 QIDI-packaging/12
