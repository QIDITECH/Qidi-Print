...
class LayFlatOperation(Operation.Operation):
    ...
    def process(self):
        ...
        # Based on https://github.com/daid/QIDI/blob/SteamEngine/QIDI/util/printableObject.py#L207
        ...
        t = str(Quaternion.fromAngleAxis(rad, Vector.Unit_Y)).translate(str.maketrans("", "", "Q<>=w")).split(',')
        ...
        t = str(Quaternion.fromAngleAxis(rad, Vector.Unit_Z)).translate(str.maketrans("", "", "Q<>=w")).split(',')
        Logger.log("d", "x = %s", math.degrees(math.atan(float(t[0]) / float(t[3]))) * 2)
        Logger.log("d", "y = %s", math.degrees(math.atan(float(t[2]) / float(t[3]))) * 2)
        Logger.log("d", "z = %s", math.degrees(math.atan(float(t[1]) / float(t[3]))) * 2)        
        ...
        t = str(Quaternion.fromAngleAxis(rad, Vector.Unit_X)).translate(str.maketrans("", "", "Q<>=w")).split(',')
        Logger.log("d", "x = %s", math.degrees(math.atan(float(t[0]) / float(t[3]))) * 2)
        Logger.log("d", "y = %s", math.degrees(math.atan(float(t[2]) / float(t[3]))) * 2)
        Logger.log("d", "z = %s", math.degrees(math.atan(float(t[1]) / float(t[3]))) * 2)
