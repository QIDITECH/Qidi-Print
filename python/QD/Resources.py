...
class Resources:
    """Class to look up any form of resource used by QDTECH or an application using QDTECH"""
    ...
    def removeType(cls, resource_type: int) -> None:
        ...
        if resource_type <= cls.UserType:
            raise ResourceTypeError("QDTECH standard types cannot be removed")
    ...
    def _copyLatestDirsIfPresent(cls) -> None:
        ...
        as the base for upgrade. See QIDI-3529 for more details.
        """
    ...
    def copyVersionFolder(cls, src_path: str, dest_path: str) -> None:
        ...
        try:
            temp_root_dir_path = tempfile.mkdtemp("qidi-copy")
