...
ComboBox
{
    ...
    contentItem: Label
    {
        ...
        color: control.currentIndex == -1 ? QD.Theme.getColor("setting_control_disabled_text") : QD.Theme.getColor("setting_control_text")
    ...
    delegate: ItemDelegate
    {
        ...
        contentItem: Label
        {
			...
			//color: delegateItem.text.search("-")!= -1 ?QD.Theme.getColor("setting_control_text"):QD.Theme.getColor("red_1")
            font: QD.Theme.getFont("default")
            elide: Text.ElideRight
            verticalAlignment: Text.AlignVCenter
        }
