...
QIDI.ExpandablePopup
{
    ...
    enabled: QIDI.MachineManager.activeMachine ? QIDI.MachineManager.activeMachine.hasMaterials || QIDI.MachineManager.activeMachine.hasVariants || QIDI.MachineManager.activeMachine.hasVariantBuildplates : false; //Only let it drop down if there is any configuration that you could change.
    ...
    headerItem: Item
    {
        ...
        Label
        {
            ...
            visible: QIDI.MachineManager.activeMachine ? !QIDI.MachineManager.activeMachine.hasMaterials && (QIDI.MachineManager.activeMachine.hasVariants || QIDI.MachineManager.activeMachine.hasVariantBuildplates) : false
    ...
    {
        id: popupItem
        width: QD.Theme.getSize("configuration_selector").width
        ...
        padding: QD.Theme.getSize("default_margin").height
        ...
        onVisibleChanged:
        {
            is_connected = QIDI.MachineManager.activeMachine.hasRemoteConnection && QIDI.MachineManager.printerConnected && QIDI.MachineManager.printerOutputDevices[0].uniqueConfigurations.length > 0 //Re-evaluate.
