...
Item {
    ...
    height: 25 * UM.Theme.getSize("default_margin").width/10//UM.Theme.getSize("section").height
    ...
    MouseArea
    {
        ...
        Label
        {
            ...
            anchors.leftMargin: Math.round((UM.Theme.getSize("section_icon_column").width + 5 * UM.Theme.getSize("default_margin").width/10) + ((definition.depth - 1) * UM.Theme.getSize("setting_control_depth_margin").width * 0.5) - 16 * UM.Theme.getSize("default_margin").width/10)
            ...
            font: UM.Theme.getFont("font1")//base.doQualityUserSettingEmphasis && base.stackLevel != undefined && base.stackLevel <= 1 ? UM.Theme.getFont("default_italic") : UM.Theme.getFont("font1")
        }
...
/*            UM.SimpleButton
            ...
            UM.SimpleButton
            {
                ...
                hoverColor: UM.Theme.getColor("color5")
