...
Item
{
    ...
    Binding
    {
        target: background
        property: "color"
        value: base.enabled ? headerBackgroundColor : QD.Theme.getColor("disabled")
    }
    ...
    RoundedRectangle
    {
        ...
        color: base.enabled ? headerBackgroundColor : QD.Theme.getColor("disabled")
        anchors.fill: parent
        ...
        Item
        {
            ...
            MouseArea
            {
                ...
                onExited: background.color = base.enabled ? headerBackgroundColor : QD.Theme.getColor("disabled")
            }
            ...
            Rectangle
            {
                ...
                width: parent.width
                height: QD.Theme.getSize("thick_lining").height
            ...
            QD.RecolorImage
            {
                ...
                source: expanded ? QD.Theme.getIcon("ChevronSingleDown") : QD.Theme.getIcon("ChevronSingleLeft")
                visible: source != ""
