        ...
        ScrollView
        {
            ...
            ListView
            {
                ...
                model: UM.SettingDefinitionsModel
                {
                    ...
                    showAll: true
                    exclude: ["shell","infill","material","speed","travel","resolution","support","platform_adhesion","dual","meshfix","blackmagic","experimental","machine_settings","command_line_settings",
                    "material_extrusion_cool_down_speed","cool_fan_speed_min","cool_fan_speed_max","cool_min_layer_time_fan_speed_max","cool_fan_full_layer","cool_lift_head","cool_fan_visiable","cooling_chamber_visiable"]
                    expanded: ["*"]
