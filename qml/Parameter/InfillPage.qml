        ...
        ScrollView
        {
            ...
            ListView
            {
                ...
                model: UM.SettingDefinitionsModel
                {
                    ...
                    showAll: true
                    exclude: ["shell","resolution","material","speed","travel","cooling","support","platform_adhesion","dual","meshfix","blackmagic","experimental","machine_settings","command_line_settings",
                    "infill_line_distance","zig_zaggify_infill","infill_offset_x","infill_offset_y","sub_div_rad_add","infill_overlap_mm","skin_overlap_mm","gradual_infill_step_height","skin_preshrink",
                    "expand_skins_expand_distance","max_skin_angle_for_expansion","infill_enable_travel_optimization","cross_infill_pocket_size","cross_infill_apply_pockets_alternatingly",
                    "spaghetti_infill_enabled","spaghetti_infill_stepped","spaghetti_max_infill_angle","spaghetti_max_height","spaghetti_inset","spaghetti_flow","spaghetti_infill_extra_volume"
                    ,"connect_infill_polygons","infill_multiplier","cross_infill_density_image","cross_support_density_image","skin_edge_support_thickness"]
                    expanded: ["*"]
