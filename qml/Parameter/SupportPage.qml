        ...
        ScrollView
        {
            ...
            ListView
            {
                ...
                model: UM.SettingDefinitionsModel
                {
                    ...
                    "support_bottom_distance","support_xy_overrides_z","support_xy_distance_overhang","support_bottom_stair_step_height","support_bottom_stair_step_width","support_join_distance",
                    ...
                    "support_mesh_drop_down","support_tree_wall_count","support_skip_some_zags","support_skip_zag_per_mm","infill_hollow","support_pillar_resolution","support_wall_count","support_initial_layer_line_distance",
                    "support_infill_angle","support_brim_enable","support_brim_width","support_brim_line_count","brim_replaces_support","support_fan_enable","support_supported_skin_fan_speed",
                    "minimum_roof_area","minimum_bottom_area","support_interface_offset","support_interface_angles","support_meshes_present"]
                    expanded: ["*"]
