        ...
        ScrollView
        {
            ...
            ListView
            {
                ...
                model: UM.SettingDefinitionsModel
                {
                    ...
                    showAll: true
                    exclude: ["shell","infill","material","speed","resolution","cooling","support","platform_adhesion","dual","meshfix","blackmagic","experimental","machine_settings","command_line_settings",
                    "default_material_print_temperature","default_material_bed_temperature","material_flow_dependent_temperature","material_flow_temp_graph","material_initial_print_temperature",
