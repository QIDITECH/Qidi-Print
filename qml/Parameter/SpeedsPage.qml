        ...
        ScrollView
        {
            ...
            ListView
            {
                ...
                model: UM.SettingDefinitionsModel
                {
                    ...
                    showAll: true
                    exclude: ["shell","infill","material","resolution","travel","cooling","support","platform_adhesion","dual","meshfix","blackmagic","experimental","machine_settings","command_line_settings",
                    "speed_roofing","speed_support_infill","speed_support_interface","speed_print_layer_0","speed_travel_layer_0","max_feedrate_z_override","speed_slowdown_layers","speed_equalize_flow_enabled",
                    "speed_equalize_flow_max","acceleration_print","acceleration_travel","acceleration_layer_0","acceleration_skirt_brim","jerk_print","jerk_travel","jerk_layer_0","jerk_skirt_brim"]
                    expanded: ["*"]
