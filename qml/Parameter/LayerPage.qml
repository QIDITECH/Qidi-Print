        ...
        ScrollView
        {
            ...
            ListView
            {
                ...
                model: UM.SettingDefinitionsModel
                {
                    ...
                    showAll: true
                    exclude: ["resolution","infill","material","speed","travel","cooling","support","platform_adhesion","dual","meshfix","blackmagic","experimental","machine_settings","command_line_settings",
                    "adaptive_layer_height_variation","adaptive_layer_height_variation_step","adaptive_layer_height_threshold","skirt_brim_line_width","support_line_width","support_interface_line_width",
                    "prime_tower_line_width","roofing_layer_count","roofing_line_width","roofing_pattern","roofing_angles",
                    "top_bottom_pattern_0","skin_angles","skin_alternate_rotation","wall_0_inset","alternate_extra_perimeter","travel_compensate_overlapping_walls_enabled","filter_out_tiny_gaps",
                    "slicing_tolerance","magic_fuzzy_skin_enabled","magic_fuzzy_skin_thickness","magic_fuzzy_skin_point_density","wall_try_line_thickness","wall_thickness","connect_skin_polygons",
                    "wall_min_flow","wall_min_flow_retract","initial_bottom_layers","magic_fuzzy_skin_outside_only"]
                    expanded: ["*"]
