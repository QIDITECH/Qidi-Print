...
Item
{
    ...
    property color activeColor: QD.Theme.getColor("primary")
    property color inactiveColor: QD.Theme.getColor("slider_groove")
    property color defaultItemColor: QD.Theme.getColor("slider_groove_fill")
    property color defaultItemFillColor: QD.Theme.getColor("main_background")
    property int checkboxSize: Math.round(QD.Theme.getSize("radio_button").height * 0.75)
    property int inactiveMarkerSize: 2 * barSize
    property int barSize: QD.Theme.getSize("slider_groove_radius").height
    ...
    Component
    {
        ...
        Item
        {
            ...
            Rectangle
            {
                ...
                // but not when using the exact same QML in QIDI.
