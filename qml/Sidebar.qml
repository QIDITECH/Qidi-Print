...
Rectangle
{
    ...
    {
        id: machineSelection
        width: base.width - 50 * UM.Theme.getSize("default_margin").width/10
        height: 50 * UM.Theme.getSize("default_margin").width/10//UM.Theme.getSize("sidebar_header").height
    ...
    Rectangle {
        ...
        visible: !monitoringPrint && !hideSettings && !hideView && header.visible
        height: 1//visible ? UM.Theme.getSize("sidebar_lining").height : 0
        color: UM.Theme.getColor("color2")
        anchors.top: header.bottom
        anchors.topMargin: 10 * UM.Theme.getSize("default_margin").width/10//visible ? UM.Theme.getSize("sidebar_margin").height : 0
    }
       ...
       // }
        ...
        Component
        {
            ...
            Button
            {
                ...
                contentItem: Label
                {
                    text: UM.Preferences.getValue("cura/active_mode")//model.text
...
/*
    Rectangle
    {
        ...
        anchors.bottom: parent.bottom //printSpecs.top
...
*/
    ...
    SaveButton
    {
        ...
        height: Cura.MachineManager.activeMachineId == "QIDI I" ? 135 * UM.Theme.getSize("default_margin").width/10 : Cura.MachineManager.activeMachineId == "X-one2" ? 135 * UM.Theme.getSize("default_margin").width/10 : wifivisible.properties.value == "False" ? 135 * UM.Theme.getSize("default_margin").width/10 : 160 * UM.Theme.getSize("default_margin").width/10//UM.Theme.getSize("jobspecs_line").height
        //anchors.bottomMargin: UM.Theme.getSize("sidebar_margin").height
        anchors.bottom: parent.bottom
        visible: !monitoringPrint
    }
