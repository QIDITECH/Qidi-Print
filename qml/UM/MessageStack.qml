...
ListView {
    ...
    delegate: Rectangle
    {
        ...
        property int totalMessageHeight: message.labelHeight + message.actionButtonsHeight - message.labelTopBottomMargin  //Math.max(message.labelHeight, message.actionButtonsHeight + message.closeButtonHeight) + message.labelTopBottomMargin
        ...
        Label {
            ...
            anchors {
                ...
                top: parent.top;
                topMargin: model.title != undefined ? Math.round(UM.Theme.getSize("default_margin").height) : 0;
            }
        ...
        Label {
            ...
            anchors {
                ...
                top: messageTitle.bottom//model.progress != null ? messageTitle.bottom : messageTitle.bottom;
        ...
        Button {
            id: closeButton;
            width: UM.Theme.getSize("message_close").width * 1.2;
            height: UM.Theme.getSize("message_close").height * 1.2;
            ...
            UM.RecolorImage {
                ...
                color: UM.Theme.getColor("color8")
                ...
                delegate: Button {
                    ...
                    style: ButtonStyle {
                        background: Item {
                            ...
                            implicitWidth: responsiveWidth > standardWidth ? responsiveWidth *1.5 : standardWidth *1.5
                            implicitHeight: UM.Theme.getSize("message_button").height * 1.5
                            Rectangle {
                            ...
                            Label {
                                ...
                                font: {
                                    if (model.button_style == 0)
                                        return UM.Theme.getFont("font2")
                                    else
                                    {
                                        var obj = UM.Theme.getFont("font2")
                                        obj.underline = true
                                        return obj
                                    }
                                }
