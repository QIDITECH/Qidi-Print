...
Button
{
	...
	property alias sourceSize: buttonIconLeft.sourceSize
    ...
    contentItem: Item
    {
        ...
        QD.RecolorImage
        {
            id: buttonIconLeft
            source: ""
            height: visible ? sourceSize? sourceSize.width : QD.Theme.getSize("action_button_icon").height : 0
            width: visible ? sourceSize? sourceSize.width : height : 0
        ...
        Label
        {
			...
			//rightPadding: 10 * QD.Theme.getSize("size").height
			//anchors.left:parent.left
			//anchors.leftMargin:button.width/2 - button.leftPadding - button.rightPadding +buttonIconLeft.width-15*QD.Theme.getSize("size").height
            /*Binding
            {
