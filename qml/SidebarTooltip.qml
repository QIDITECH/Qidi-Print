...
UM.PointingRectangle {
    ...
    width: UM.Theme.getSize("tooltip").width + 30;
    height: label.height + 5*2//UM.Theme.getSize("tooltip_margins").height * 2;
    ...
    Label {
        ...
        anchors {
            top: parent.top;
            topMargin: 5//UM.Theme.getSize("tooltip_margins").height;
            left: parent.left;
