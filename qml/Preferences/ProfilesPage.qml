...
/*
    ...
    MessageDialog
    {
        ...
        onYes:
        {
            ...
            if(isCurrentItemActivated)
            {
                qualityListView.currentIndex = 0;  // Reset selection.  回到列表第一项，并激活他
                if (base.currentItem.is_read_only) {
                    Cura.MachineManager.setQualityGroup(base.currentItem.quality_group);
                } else {
                    Cura.MachineManager.setQualityChangesGroup(base.currentItem.quality_changes_group);
...
*/
    Item
    {
        ...
        Label
        {
            ...
            visible: text != ""
            text: catalog.i18nc("@title:tab", "Please select the profiles you would like to remove.")
...
/*
                ...
                section.delegate: Rectangle
                {
                    ...
                    Label
                    {
                        ...
                        text: section == "true" ? model.is_read_only : model.is_read_only//catalog.i18nc("@label", "Protected profiles") : catalog.i18nc("@label", "Custom profiles")
                        font.bold: true
                    }
                }*/
                ...
                delegate: Rectangle
                {
                    ...
                    visible: model.is_read_only ? false : true
