...
fragment =
    ...
    void main()
    {
        gl_FragColor = u_color * u_disabledMultiplier; //Always use the uniform colour. The entire mesh will be the same colour.
    }
...
fragment41core =
    ...
    void main()
    {
        frag_color = u_color * u_disabledMultiplier; //Always use the uniform colour. The entire mesh will be the same colour.*/
