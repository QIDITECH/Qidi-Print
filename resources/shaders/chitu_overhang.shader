...
fragment =
    ...
    uniform mediump int u_shininess;
    ...
    void main()
    {
        ...
        finalColor += (NdotR * NdotR * NdotR * NdotR * NdotR * u_specularColor);
...
fragment41core =
    ...
    void main()
    {
        ...
        highp vec3 viewVector = normalize(u_viewPosition - f_vertex);
        highp float NdotR = clamp(dot(viewVector, reflectedLight), 0.0, 1.0);
        finalColor += NdotR * NdotR * NdotR * NdotR * NdotR * u_specularColor;          //pow seem to be some problem in some machine
...
[defaults]
u_ambientColor = [0.25, 0.25, 0.25, 1.0]
u_diffuseColor = [1.0, 0.79, 0.14, 1.0]
u_specularColor = [0.10, 0.10, 0.10, 1.0]
